      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="flex h-[96dvh] w-full flex-col overflow-hidden rounded-t-2xl border border-white/10 bg-zinc-900 shadow-2xl sm:h-[90vh] sm:max-w-4xl sm:rounded-xl"
